...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/Digitex-Softwares/Digitex-MD");
    const {
      name: _0x4ae93b,
